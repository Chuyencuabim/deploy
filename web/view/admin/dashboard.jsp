<%-- 
    Document   : dashboard
    Created on : Jun 15, 2022, 2:14:44 AM
    Author     : ADMIN
--%>
...
<html>
    ...
    <!-- All PLUGINS CSS ============================================= -->
	<link rel="stylesheet" type="text/css" href="../admin/assets/css/../admin/assets.css">
		...
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
						<a href="../../course/add" class="ttr-material-button">
							<span class="ttr-icon"><i class="ti-book"></i></span>
		                	<span class="ttr-label">New Courses</span>
		                </a>
		            </li>
					<li>
